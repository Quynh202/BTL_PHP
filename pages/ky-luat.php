...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  // hien thi ky luat
  $kt = "SELECT ktkl.id as id, ma_kt, ten_cb, so_qd, ngay_qd, ten_loai, hinh_thuc, so_tien, ktkl.ngay_tao as ngay_tao FROM khen_thuong_ky_luat ktkl, can_bo cb, loai_khen_thuong_ky_luat lktkl WHERE ktkl.canbo_id = cb.id AND ktkl.loai_kt_id = lktkl.id AND ktkl.flag = 0 ORDER BY ktkl.ngay_tao DESC";
  ...
  if(isset($_POST['taoKyLuat']))
  {
    ...
    if($nhanVien == 'chon')
      $error['nhanVien'] = 'Vui lòng chọn <b> cán bộ </b>';
    ...
    {
      $showMess = true;
      $insert = "INSERT INTO khen_thuong_ky_luat(ma_kt, so_qd, ngay_qd, canbo_id, loai_kt_id, hinh_thuc, so_tien, flag, ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua) VALUES('$maKyLuat', '$soQuyetDinh', '$ngayQuyetDinh', '$nhanVien', '$loaiKyLuat', '$hinhThuc', '$soTienPhat', '$flag', '$moTa', '$nguoiTao', '$ngayTao', '$nguoiTao', '$ngayTao')";
      $result = mysqli_query($conn, $insert);
      if($result)
      {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kỷ luật cán bộ</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <a href="ky-luat.php?p=bonus-discipline&a=discipline&ky-luat" class="btn btn-app">
                <i class="fa fa-user"></i> Kỷ luật cán bộ
              </a>
              <?php 
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Kỷ luật cán bộ</h3>
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
              </div>
