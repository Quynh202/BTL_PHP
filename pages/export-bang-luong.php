<?php 
	...
	// PHPExcel
  	...
  	$sheet->setCellValue('C' . $rowCount, 'Tên cán bộ');
  	...
  	// do du lieu tu db
  	$sql = "SELECT ma_luong, hinh_anh, cb.id as idNhanVien, ten_cb, ten_chuc_vu, luong_thang, ngay_cong, phu_cap, khoan_nop, tam_ung, thuc_lanh, ngay_cham FROM luong l, can_bo cb, chuc_vu cv WHERE cb.id = l.canbo_id AND cb.chuc_vu_id = cv.id";
