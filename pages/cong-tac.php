...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  // show data
  $NV = "SELECT id, ma_cb, ten_cb FROM can_bo";
  ...
  if(isset($_POST['save']))
  {
    ...
    $check = "SELECT canbo_id FROM cong_tac WHERE canbo_id = '$maNhanVien'";
    $resultCheck = mysqli_query($conn, $check);
    if(mysqli_num_rows($resultCheck) != 0)
    {
      $error['dangCongTac'] = 'error';
      echo "<script>alert('Cán bộ này đang trong quá trình công tác');</script>";
    }
    ...
    {
      $showMess = true;
      $insert = "INSERT INTO cong_tac(ma_cong_tac, canbo_id, ngay_bat_dau, ngay_ket_thuc, dia_diem, muc_dich, ghi_chu, nguoi_tao, ngay_tao) VALUES('$maCongTac','$maNhanVien', '$ngayBatDau', '$ngayKetThuc', '$diaDiem', '$mucDich', '$ghiChu', '$nguoiTao', '$ngayTao')";
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Chọn cán bộ<span style="color: red;">*</span> : </label>
