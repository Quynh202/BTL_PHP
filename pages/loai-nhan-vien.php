...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  // show data
  $showData = "SELECT id, ma_loai_cb, ten_loai_cb, ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua FROM loai_cb ORDER BY ngay_tao DESC";
  ...
  if(isset($_POST['save']))
  {
    ...
    // validate
    if(empty($typeName))
      $error['typeName'] = 'Vui lòng nhập <b> loại cán bộ </b>';

    if(!$error)
    {
      $showMess = true;
      $insert = "INSERT INTO loai_cb(ma_loai_cb, ten_loai_cb, ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua) VALUES('$typeCode','$typeName', '$description', '$personCreate', '$dateCreate', '$personEdit', '$dateEdit')";
      $result = mysqli_query($conn, $insert);
      if($result)
      {
        $success['success'] = 'Tạo loại cán bộ thành công';
  ...
  if(isset($_POST['delete']))
  {
    ...
    $id = $_POST['idType'];
    $delete = "DELETE FROM loai_cb WHERE id = $id";
    $result = mysqli_query($conn, $delete);
    if($result)
    {
      $success['success'] = 'Xóa loại cán bộ thành công.';
      echo '<script>setTimeout("window.location=\'loai-nhan-vien.php?p=staff&a=employee-type\'",1000);</script>';
    }
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Bạn có thực sự muốn xóa loại cán bộ này?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="loai-nhan-vien.php?p=staff&a=employee-type">Loại cán bộ</a></li>
        <li class="active">Tạo loại cán bộ</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tạo loại cán bộ</h3>
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Tạo loại cán bộ</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Danh sách loại cán bộ</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $arrS['ma_loai_cb']; ?></td>
                        <td><?php echo $arrS['ten_loai_cb']; ?></td>
