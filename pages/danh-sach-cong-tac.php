...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  // show data
  $showData = "SELECT ct.id as id, ma_cong_tac, ten_cb, ten_chuc_vu, ngay_bat_dau, ngay_ket_thuc, dia_diem, muc_dich, nam_tang_luong_min FROM  can_bo cb, chuc_vu cv, cong_tac ct WHERE cb.chuc_vu_id = cv.id AND cb.id = ct.canbo_id ORDER BY ct.ngay_tao DESC";
