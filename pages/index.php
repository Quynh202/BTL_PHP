...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
	...
	$nv = "SELECT count(id) as soluong FROM can_bo";
	$resultNV = mysqli_query($conn, $nv);
	$rowNV = mysqli_fetch_array($resultNV);
	$tongNV = $rowNV['soluong'];

	// dem so luong nhan vien nghỉ việc
	$nghiViec = "SELECT count(id) as soluong FROM can_bo WHERE trang_thai = 0";
	...
	$luongThang = "SELECT ma_luong, hinh_anh, ten_cb, gioi_tinh, ngay_sinh, luong_thang, khoan_nop, thuc_lanh, trang_thai from luong l, can_bo cb WHERE l.canbo_id = cb.id AND year(ngay_cham) = '$namHienTai' AND month(ngay_cham) = '$thangHienTai' ORDER BY l.id DESC";
	      ...
	      <div class="row">
	        <div class="col-lg-3 col-xs-6">
	          ...
	          <div class="small-box bg-aqua">
	            ...
	            <a href="danh-sach-nhan-vien.php?p=staff&a=list-staff" class="small-box-footer">Danh sách cán bộ <i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
	        <div class="col-lg-3 col-xs-6">
