...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  {
    $id = $_GET['id'];
    $showData = "SELECT id, ma_loai_cb, ten_loai_cb, ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua FROM loai_cb WHERE id = $id";
  ...
  if(isset($_POST['save']))
  {
    ...
    {
      $showMess = true;
      $update = " UPDATE loai_cb SET 
                  ten_loai_cb = '$typeName',
                  ghi_chu = '$description',
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="speacialCode" value="<?php echo $row['ma_loai_cb']; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tên loại: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên loại" name="typeName" value="<?php echo $row['ten_loai_cb']; ?>">
                    </div>
                    <div class="form-group">
