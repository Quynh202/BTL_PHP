...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  {
    $id = $_GET['id'];
    $act = "SELECT ma_cong_tac, cb.id as idNhanVien, ma_cb, ten_cb, ngay_bat_dau, ngay_ket_thuc, dia_diem, muc_dich, ghi_chu FROM cong_tac ct, can_bo cb WHERE ct.canbo_id = cb.id AND ct.id = $id";
