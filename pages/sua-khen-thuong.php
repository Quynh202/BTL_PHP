...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_GET['id']))
  {
    ...
    // set value active
    $nvAC = "SELECT cb.id as idAC, ma_cb, ten_cb, lktkl.id as loai_id, ten_loai FROM khen_thuong_ky_luat ktkl, can_bo cb, loai_khen_thuong_ky_luat lktkl WHERE cb.id = ktkl.canbo_id AND lktkl.id = ktkl.loai_kt_id AND  ma_kt = '$id'";
    ...
    // hien thi nhan vien
    $nv = "SELECT id, ma_cb, ten_cb FROM can_bo WHERE id <> $idNVAC";
