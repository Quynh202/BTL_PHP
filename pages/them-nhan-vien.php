...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  // ----- Loại nhân viên
  $loaiNhanVien = "SELECT id, ten_loai_cb FROM loai_cb";
  ...
  if(isset($_POST['save']))
  {
    ...
    $hangCb = $_POST['hangCb']; 
    $bacNhomNgach = $_POST['bacNhomNgach']; 
    ...
    if(empty($hangCb))
      $error['hangCb'] = 'error'; 
    if(empty($bacNhomNgach))
      $error['bacNhomNgach'] = 'error'; 
    ...
    //validate hang, bac luong 
    $regExp = '/[a-zA-Z]/'; 
    $regExp1 = '/[!@#$%^&*()-+]/'; 
    if(!preg_match($regExp, $hangCb)){
      if(!preg_match($regExp1, $hangCb)){
        $error['kieuHangCB'] = ''; 
      } else {
        $error['kieuHangCB'] = 'error'; 
      }
    } else {
      $error['kieuHangCb'] = 'error'; 
    }
    ...
    $regExp = '/[a-zA-Z]/'; 
    $regExp1 = '/[!@#$%^&*()-+]/'; 
    if(!preg_match($regExp, $bacNhomNgach)){
      if(!preg_match($regExp1, $bacNhomNgach)){
        $error['bacLuong'] = ''; 
      } else {
    ...
    if(!$error)
    {
      if($hinhAnh)
      {
        ...
        // insert data
        $insert = "INSERT INTO can_bo(ma_cb, hinh_anh, ten_cb, biet_danh, gioi_tinh, ngay_sinh, noi_sinh, hon_nhan_id, so_cmnd, noi_cap_cmnd, ngay_cap_cmnd, nguyen_quan, quoc_tich_id, ton_giao_id, dan_toc_id, ho_khau, tam_tru, loai_cb_id, trinh_do_id, chuyen_mon_id, bang_cap_id, phong_ban_id, chuc_vu_id, trang_thai, nguoi_tao_id, ngay_tao, nguoi_sua_id, ngay_sua, hang_cb, bac_nhom_ngach) VALUES('$maNhanVien', '$imageName', '$tenNhanVien', '$bietDanh', '$gioiTinh', '$ngaySinh', '$noiSinh', '$honNhan', '$CMND', '$noiCap', '$ngayCap', '$nguyenQuan', '$quocTich', '$tonGiao', '$danToc', '$hoKhau', '$tamTru', '$loaiNhanVien', '$trinhDo', '$chuyenMon', '$bangCap', '$phongBan', '$chucVu', '$trangThai', '$id_user', '$ngayTao', '$id_user', '$ngayTao', '$hangCb', '$bacNhomNgach')";
        ...
        if($result)
        {
          ...
          $success['success'] = 'Thêm cán bộ thành công';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="them-nhan-vien.php?p=staff&a=add-staff">Cán bộ</a></li>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Thêm mới cán bộ</h3> &emsp;
            ...
            <div class="box-body">
              ...
              <form action="" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <option value="chon">--- Chọn loại cán bộ ---</option>
                      <?php 
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập hạng cán bộ" name="hangCb" value="<?php echo isset($_POST['hangCb']) ? $_POST['hangCb'] : ''; ?>">
                      <small style="color: red;"><?php if(isset($error['hangCb'])){ echo "Vui lòng nhập hạng cán bộ"; } ?></small>
                    </div>
                    <div class="form-group">
                      <label>Bậc nhóm ngạch: <span style="color: red;">*</span>: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập bậc nhóm ngạch" name="bacNhomNgach" value="<?php echo isset($_POST['bacNhomNgach']) ? $_POST['bacNhomNgach'] : ''; ?>">
                      <small style="color: red;"><?php if(isset($error['bacNhomNgach'])){ echo "Vui lòng nhập bậc nhóm ngạch"; } ?></small>
                    </div>
                  </div>
                  <!-- /.col -->
                </div>
                ...
                <?php 
                  if($_SESSION['level'] == 1)
                    echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Thêm mới cán bộ</button>";
                ?>
              </form>
            </div>
            <!-- /.box-body -->
