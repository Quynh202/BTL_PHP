      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Bạn có thực sự muốn xóa <?php if(isset($_GET['tao-loai'])){ echo "loại khen thưởng"; }else{ echo "khen thưởng"; } ?> này?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Khen thưởng cán bộ</li>
      </ol>
    </section>
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tên khen thưởng: </label>
