...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  // show data
  $showData = "SELECT id, ma_cb, ten_cb FROM can_bo ORDER BY id DESC";
  ...
  $nv = "SELECT ctn.id as id, ma_cb, hinh_anh, ten_cb, gioi_tinh, ngay_sinh, ten_chuc_vu, ten_phong_ban, ctn.ngay_tao as ngay_tao, trang_thai FROM chi_tiet_nhom ctn, can_bo cb, chuc_vu cv, phong_ban pb WHERE ctn.can_bo_id = cb.id AND cb.chuc_vu_id = cv.id AND cb.phong_ban_id = pb.id AND ma_nhom = '$id'";
  ...
  if(isset($_POST['luuNhanVien']))
  {
    ...
    $kt = "SELECT can_bo_id FROM chi_tiet_nhom WHERE can_bo_id = '$nhanVien' AND ma_nhom = '$id'";
    $resultKT = mysqli_query($conn, $kt);
    if(mysqli_num_rows($resultKT) != 0)
      $error['tonTai'] = 'Cán bộ này <b> đã tồn tại </b> trong nhóm';

    if(!$error)
    {
      $showMess = true;
      $insert = "INSERT INTO chi_tiet_nhom(ma_nhom, can_bo_id, nguoi_tao, ngay_tao) VALUES('$id', '$nhanVien', '$nguoiTao', '$ngayTao')";
      $result = mysqli_query($conn, $insert);
      if($result)
      {
        $success['success'] = 'Thêm can bo vào nhóm thành công';
  ...
  if(isset($_POST['delete']))
  {
    ...
    $success['success'] = 'Đã xóa cán bộ ra khỏi nhóm thành công.';
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Bạn có thực sự muốn xóa cán bộ này ra khỏi nhóm?
          </div>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Thêm cán bộ vào nhóm</h3>
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
              </div>
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Chọn cán bộ: </label>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Cán bộ trong nhóm</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <?php 
