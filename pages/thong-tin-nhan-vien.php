            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-lg-5 col-sm-5 col-md-6 col-xs-12">
                  ...
                  <p class="box-title">Bậc nhóm ngạch: 
                    <b><?php echo $row['bac_nhom_ngach']; ?></b>
                  </p>
